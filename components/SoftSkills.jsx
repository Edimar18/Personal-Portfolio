...
const marks = [
  // Communication — two intersecting circles
  ...
  // Adaptability — rotated square morphing to diamond
  ...
  return (
    <section id="skills" className="relative px-6 md:px-10 py-28 md:py-36 bg-paper-dim">
      <div className="mx-auto max-w-[1400px]">
        <SectionHeading code="05" title="Soft Skills" />
