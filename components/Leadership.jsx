  ...
  return (
    <section id="leadership" className="relative px-6 md:px-10 py-28 md:py-36 bg-paper-dim">
      <div className="mx-auto max-w-[1400px]">
        <SectionHeading code="04" title="Leadership Experience" sub="Governance & Community Leadership" />
          ...
          {leadership.map((l, i) => (
            <ScrollReveal key={l.org} delay={i * 100} className="bg-paper">
              <article className="grid grid-cols-1 md:grid-cols-12">
                {/* Photo plate */}
                <div className="md:col-span-5 relative h-72 md:h-auto min-h-[300px] overflow-hidden bg-ink">
                  {l.image ? (
                    <img
                      src={l.image}
                      alt={l.org}
                ...
                <div className="md:col-span-7 p-8 md:p-12 flex flex-col justify-center">
                  ...
                  <ul className="mt-5 space-y-2">
                    {l.achievements.map((a) => (
                      <li key={a} className="text-sm text-ink-soft flex gap-3 leading-relaxed">
